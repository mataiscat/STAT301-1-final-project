...
View distribution of `age`. Notice, there are still 116866 `NA` values in `age` removed by `geom_histogram()` here (~42% of all data). However, I am cautious to visualizing the effect these large amount of `NA` will do in skewing the representation of age. 
